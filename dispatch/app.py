...
def route_config_sdk_combo():
    return "{""retcode"":0,""message"":""OK"",""data"":{""vals"":{""kibana_pc_config"":""{ \"enable\": 1, \"level\": \"Debug\",\"modules\": [\"download\"]"",""list_price_tierv2_enable"":""false\n"",""network_report_config"":""{ \"enable\": 1, \"status_codes\": [206], \"url_paths\": [\"dataUpload\", \"red_dot\"] }""}}}"


@app.route("/device-fp/api/getExtList")
def route_config_sdk_combo():
    return "{""retcode"":0,""message"":""OK"",""data"":{""code"":200,""msg"":""ok"",""ext_list"":[""cpuName"",""systemName"",""systemType"",""deviceUID"",""gpuID"",""gpuName"",""gpuAPI"",""gpuVendor"",""gpuVersion"",""gpuMemory"",""osVersion"",""cpuCores"",""cpuFrequency"",""gpuVendorID"",""isGpuMultiTread"",""memorySize"",""screenSize"",""engineName"",""addressMAC""],""pkg_list"":[]}}"
...
@app.route("bh3_usa/mdk/shield/api/loadConfig", method="POST")
...
# @app.route("/admin/mi18n/plat_oversea/*#")
# def route_plat_oversea():
#     return {"version": 67}

@app.route("/bh3_usa/combo/granter/api/compareProtocolVersion")
...
@app.route("/bh3_usa/combo/granter/api/getProtocol")
...
def run_http_server(host):
    app.run(host=host, port="81",silent=True)
